...
namespace MvcWeb.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(ILogger<CartController> logger, ICartService cartService, UserManager<Piranha.AspNetCore.Identity.Data.User> userManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var userCart = await _cartService.GetOrCreateUserCartAsync(user.Id.ToString());
        ...
        public async Task<IActionResult> AddToCart(int productId)
        {
            try
            {
                ...
                var success = await _cartService.AddToCartAsync(user.Id.ToString(), productId);
        ...
        public async Task<IActionResult> UpdateQuantity(int productId, int delta)
        {
            try
            {
                ...
                var success = await _cartService.UpdateQuantityAsync(user.Id.ToString(), productId, delta);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                var success = await _cartService.DeleteCartItemAsync(user.Id.ToString(), id);
